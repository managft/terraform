module "cs-svc-team-1-prod-svc-sssy" {
  ...
  project_id      = "team-1-prod-svc-sssy"
  org_id          = var.org_id
  billing_account = var.billing_account
  folder_id       = module.cs-envs["Team 1"].ids["Production"]

  shared_vpc = module.cs-vpc-host-prod-fd930-ie900.project_id
...
module "cs-svc-team-1-nonprod-svc-sssy" {
  ...
  project_id      = "team-1-nonprod-svc-sssy"
  org_id          = var.org_id
  billing_account = var.billing_account
  folder_id       = module.cs-envs["Team 1"].ids["Non-Production"]

  shared_vpc = module.cs-vpc-host-nonprod-fd930-ie900.project_id
...
module "cs-svc-team-2-prod-svc-sssy" {
  ...
  project_id      = "team-2-prod-svc-sssy"
  org_id          = var.org_id
  billing_account = var.billing_account
...
module "cs-svc-team-2-nonprod-svc-sssy" {
  ...
  project_id      = "team-2-nonprod-svc-sssy"
  org_id          = var.org_id
  billing_account = var.billing_account

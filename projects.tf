module "cs-vpc-host-prod-fd930-ie900" {
  ...
  name       = "vpc-host-prod"
  project_id = "vpc-host-prod-fd930-ie900"
  org_id     = var.org_id
...
module "cs-vpc-host-nonprod-fd930-ie900" {
  ...
  project_id = "vpc-host-nonprod-fd930-ie900"
  org_id     = var.org_id
  folder_id  = module.cs-common.id
...
module "cs-logging-fd930-ie900" {
  ...
  name       = "logging"
  project_id = "logging-fd930-ie900"
  org_id     = var.org_id
  folder_id  = module.cs-common.id
...
module "cs-monitoring-prod-fd930-ie900" {
  ...
  project_id = "monitoring-prod-fd930-ie900"
  org_id     = var.org_id
  folder_id  = module.cs-common.id
...
module "cs-monitoring-nonprod-fd930-ie900" {
  ...
  project_id = "monitoring-nonprod-fd930-ie900"
  org_id     = var.org_id
  folder_id  = module.cs-common.id
...
module "cs-monitoring-dev-fd930-ie900" {
  ...
  name       = "monitoring-dev"
  project_id = "monitoring-dev-fd930-ie900"
  org_id     = var.org_id
  folder_id  = module.cs-common.id
